...
function buildQuestRuleSections(
  ...
  const registrationItems = isRestDayEve
    ? [
      "休日前日・長期休みは「今日の寝る時間」を選べる（21:00 / 22:00 / 23:00・初期は21時）",
      "寝る時間の設定は当日18:00まで。それ以降はママの設定画面からのみ変更できるよ",
  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...registrationItems,
        "定時ボーナスは、時間内に登録して、1問目の寝る準備を「できた」と答え、ママも「できた」と確認した日に付く",
        "寝る準備を「できた」と答えたのにできていなかった日は、虚偽ペナルティ -30分",
    ...
    },
    {
      ...
      items: [
        ...
        "嘘（できたと言ったのにできていない）: -10分。寝る準備のボーナス狙いの嘘は -30分。正直に答えよう",
      ],
    },
    {
